...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,__ref.getField(false,"_mbase" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_MOVE_NOTOUCH"))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_cmax,BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_s,BA.numberCast(float.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_r,_cmax)) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_g,_cmax)) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",_h,BA.numberCast(float.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_x,__ref.getField(true,"_dont_change" /*RemoteObject*/ ))) { 
