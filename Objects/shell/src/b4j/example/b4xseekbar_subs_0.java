...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_DOWN"))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_MOVE"))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_UP"))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",__ref.getField(true,"_size" /*RemoteObject*/ ),BA.numberCast(int.class, 0))) { 
