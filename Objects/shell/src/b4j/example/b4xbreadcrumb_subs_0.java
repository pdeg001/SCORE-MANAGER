...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group10 = b4xbreadcrumb.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("\\|")),(Object)(_items));
final int groupLen10 = group10.getField(true,"length").<Integer>get()
;int index10 = 0;
;
for (; index10 < groupLen10;index10++){
_s = group10.getArrayElement(true,RemoteObject.createImmutable(index10));Debug.locals.put("s", _s);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mitems" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_presseditem" /*RemoteObject*/ ),BA.numberCast(int.class, _i))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_strokecolor,BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_rightpositions" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",_y,BA.numberCast(int.class, 0)) || RemoteObject.solveBoolean(">",_y,BA.numberCast(int.class, __ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getHeight")))) { 
if (true) return BA.numberCast(int.class, -(double) (0 + 1));};
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_x,_r)) { 
if (true) return BA.numberCast(int.class, -(double) (0 + 1));};
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_prev,__ref.getField(true,"_presseditem" /*RemoteObject*/ ))) { 
__ref.runClassMethod (b4j.example.b4xbreadcrumb.class, "_draw" /*RemoteObject*/ );};
 break; }
case 2: {
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_index,__ref.getField(true,"_presseditem" /*RemoteObject*/ )) && RemoteObject.solveBoolean(">",_index,BA.numberCast(int.class, -(double) (0 + 1)))) { 
