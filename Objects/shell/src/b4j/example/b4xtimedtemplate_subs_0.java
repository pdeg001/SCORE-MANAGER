...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getNumberOfViews"),BA.numberCast(int.class, 0))) { 
...
//if
this.state = 4;
if (RemoteObject.solveBoolean("=",_myindex,__ref.getField(true,"_index" /*RemoteObject*/ ))) { 
this.state = 3;
}if (true) break;
