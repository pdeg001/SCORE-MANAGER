...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_parent.runMethod(true,"getNumberOfViews"),BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("k",_originaltextwidth,BA.numberCast(float.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")))) { 
...
//if
this.state = 6;
if (RemoteObject.solveBoolean("!",_myindex,__ref.getField(true,"_taskindex" /*RemoteObject*/ ))) { 
this.state = 3;
;}if (true) break;
