...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",_progress,BA.numberCast(float.class, 0.5))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_angle,BA.numberCast(int.class, 0))) { 
...
//do while
this.state = 4;
while (RemoteObject.solveBoolean("=",_myindex,__ref.getField(true,"_index" /*RemoteObject*/ ))) {
this.state = 3;
if (true) break;
}
if (true) break;
