...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,123);
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 130;BA.debugLine="If CustomListView1.Size >= MaxNumberOfItemsToSho";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("g",__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(true,"_getsize"),__ref.getField(true,"_maxnumberofitemstoshow" /*RemoteObject*/ ))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 131;BA.debugLine="Dim item As String = li.Get(i)";
Debug.JustUpdateDeviceLine();
_item = BA.ObjectToString(_li.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("item", _item);Debug.locals.put("item", _item);
 BA.debugLineNum = 132;BA.debugLine="Dim x As Int = item.ToLowerCase.IndexOf(full)";
Debug.JustUpdateDeviceLine();
_x = _item.runMethod(true,"toLowerCase").runMethod(true,"indexOf",(Object)(_full));Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 133;BA.debugLine="If x = -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_x,BA.numberCast(int.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 134;BA.debugLine="Continue";
Debug.JustUpdateDeviceLine();
if (true) continue;
 };
 BA.debugLineNum = 136;BA.debugLine="Dim pnlColor As Int";
Debug.JustUpdateDeviceLine();
_pnlcolor = RemoteObject.createImmutable(0);Debug.locals.put("pnlColor", _pnlcolor);
 BA.debugLineNum = 137;BA.debugLine="If CustomListView1.Size = 0 And full.Length > 0";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(true,"_getsize"),BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean(">",_full.runMethod(true,"length"),BA.numberCast(int.class, 0))) { 
...
_pnlcolor = __ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextbackgroundcolor");Debug.locals.put("pnlColor", _pnlcolor);};
 BA.debugLineNum = 157;BA.debugLine="tf.Reset";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (b4j.example.b4jtextflow.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 158;BA.debugLine="If x > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_x,BA.numberCast(int.class, 0))) { 
 BA.debugLineNum = 159;BA.debugLine="tf.Append(item.SubString2(0, x)).SetColor(Custo";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (b4j.example.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(_item.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(_x)))).runClassMethod (b4j.example.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextcolor")));
 ...
 BA.debugLineNum = 161;BA.debugLine="If full.Length > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_full.runMethod(true,"length"),BA.numberCast(int.class, 0))) { 
 BA.debugLineNum = 162;BA.debugLine="tf.Append(item.SubString2(x, x + full.Length)).";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (b4j.example.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(_item.runMethod(true,"substring",(Object)(_x),(Object)(RemoteObject.solve(new RemoteObject[] {_x,_full.runMethod(true,"length")}, "+",1, 1))))).runClassMethod (b4j.example.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_texthighlightcolor" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 164;BA.debugLine="If x + full.Length < item.Length Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_x,_full.runMethod(true,"length")}, "+",1, 1),_item.runMethod(true,"length"))) { 
 BA.debugLineNum = 165;BA.debugLine="tf.Append(item.SubString(x + full.Length)).SetC";
Debug.JustUpdateDeviceLine();
...
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 168;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, CustomListView1.AsV";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getWidth")),(Object)(BA.numberCast(double.class, b4xsearchtemplate.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60))))));
 BA.debugLineNum = 169;BA.debugLine="Dim TextPane As B4XView = tf.CreateTextFlow";
Debug.JustUpdateDeviceLine();
...
_textpane = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _tf.runClassMethod (b4j.example.b4jtextflow.class, "_createtextflow" /*RemoteObject*/ ).getObject());Debug.locals.put("TextPane", _textpane);
 BA.debugLineNum = 170;BA.debugLine="p.AddView(TextPane, 0, p.Height / 2 - 12, p.Widt";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView",(Object)((_textpane.getObject())),(Object)(BA.numberCast(double.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getHeight"),RemoteObject.createImmutable(2),RemoteObject.createImmutable(12)}, "/-",1, 0)),(Object)(_p.runMethod(true,"getWidth")),(Object)(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "/",0, 0)));
 BA.debugLineNum = 171;BA.debugLine="p.Color = pnlColor";
Debug.JustUpdateDeviceLine();
_p.runMethod(true,"setColor",_pnlcolor);
 BA.debugLineNum = 172;BA.debugLine="CustomListView1.Add(p, item)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runVoidMethod ("_add",(Object)(_p),(Object)((_item)));
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 175;BA.debugLine="For i = 0 To li.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step30 = 1;
final int limit30 = RemoteObject.solve(new RemoteObject[] {_li.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step30 > 0 && _i <= limit30) || (step30 < 0 && _i >= limit30) ;_i = ((int)(0 + _i + step30))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 176;BA.debugLine="Dim item As String = li.Get(i)";
Debug.JustUpdateDeviceLine();
_item = BA.ObjectToString(_li.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("item", _item);Debug.locals.put("item", _item);
 BA.debugLineNum = 177;BA.debugLine="Dim x As Int = item.ToLowerCase.IndexOf(full)";
Debug.JustUpdateDeviceLine();
_x = _item.runMethod(true,"toLowerCase").runMethod(true,"indexOf",(Object)(_full));Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 178;BA.debugLine="If x = -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_x,BA.numberCast(int.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 179;BA.debugLine="Continue";
Debug.JustUpdateDeviceLine();
if (true) continue;
 };
 }
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,117);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 117;BA.debugLine="Private Sub CustomListView1_ItemClick (Index As In";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 118;BA.debugLine="If Value = \"\" Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_value,RemoteObject.createImmutable(("")))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 119;BA.debugLine="SelectedItem = Value";
Debug.JustUpdateDeviceLine();
__ref.setField ("_selecteditem" /*RemoteObject*/ ,BA.ObjectToString(_value));
 BA.debugLineNum = 120;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,233);
if (RapidSub.canDelegate("dialogclosed")) { return __ref.runUserSub(false, "b4xsearchtemplate","dialogclosed", __ref, _result);}
Debug.locals.put("Result", _result);
 BA.debugLineNum = 233;BA.debugLine="Private Sub DialogClosed(Result As Int) 'ignore";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,59);
...
Debug.locals.put("Dialog", _dialog);
 BA.debugLineNum = 59;BA.debugLine="Public Sub GetPanel (Dialog As B4XDialog) As B4XVi";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 60;BA.debugLine="Return mBase";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,22);
...
_sv.runMethod(false,"getInnerNode").runMethod(false,"getStyleClasses").runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("b4xdialog"))));
 BA.debugLineNum = 38;BA.debugLine="Dim jo As JavaObject = Me";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 39;BA.debugLine="jo.RunMethod(\"RemoveWarning\", Null)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,52);
...
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, _width)),(Object)(BA.numberCast(double.class, _height)));
 BA.debugLineNum = 54;BA.debugLine="Dim c As B4XView = CustomListView1.AsView";
Debug.JustUpdateDeviceLine();
...
_c = __ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_asview");Debug.locals.put("c", _c);Debug.locals.put("c", _c);
 BA.debugLineNum = 55;BA.debugLine="c.SetLayoutAnimated(0, 0, c.Top, Width, Height -";
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(_c.runMethod(true,"getTop")),(Object)(BA.numberCast(double.class, _width)),(Object)(RemoteObject.solve(new RemoteObject[] {_height,_c.runMethod(true,"getTop")}, "-",1, 0)));
 BA.debugLineNum = 56;BA.debugLine="CustomListView1.Base_Resize(Width, c.Height)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,110);
if (RapidSub.canDelegate("searchfield_enterpressed")) { return __ref.runUserSub(false, "b4xsearchtemplate","searchfield_enterpressed", __ref);}
 BA.debugLineNum = 110;BA.debugLine="Private Sub SearchField_EnterPressed";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 111;BA.debugLine="If CustomListView1.Size > 0 And LastTerm.Length >";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(true,"_getsize"),BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean(">",__ref.getField(true,"_lastterm" /*RemoteObject*/ ).runMethod(true,"length"),BA.numberCast(int.class, 0))) { 
 BA.debugLineNum = 112;BA.debugLine="CustomListView1_ItemClick(0, CustomListView1.Get";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,79);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 79;BA.debugLine="Private Sub SearchField_TextChanged (Old As String";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 80;BA.debugLine="Update(New, False)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,225);
...
Debug.locals.put("Index", _index);
 BA.debugLineNum = 225;BA.debugLine="Public Sub SetIndex(Index As Object)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 226;BA.debugLine="Dim obj() As Object";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,186);
...
Debug.locals.put("Items", _items);
 BA.debugLineNum = 186;BA.debugLine="Public Sub SetItems(Items As List) As Object";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 187;BA.debugLine="Dim startTime As Long";
Debug.JustUpdateDeviceLine();
_starttime = RemoteObject.createImmutable(0L);Debug.locals.put("startTime", _starttime);
 BA.debugLineNum = 188;BA.debugLine="startTime = DateTime.Now";
Debug.JustUpdateDeviceLine();
_starttime = b4xsearchtemplate.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("startTime", _starttime);
 BA.debugLineNum = 189;BA.debugLine="Dim noDuplicates As Map";
Debug.JustUpdateDeviceLine();
_noduplicates = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("noDuplicates", _noduplicates);
 BA.debugLineNum = 190;BA.debugLine="noDuplicates.Initialize";
Debug.JustUpdateDeviceLine();
_noduplicates.runVoidMethod ("Initialize");
 BA.debugLineNum = 191;BA.debugLine="prefixList.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_prefixlist" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 192;BA.debugLine="substringList.Clear";
Debug.JustUpdateDeviceLine();
...
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("m", _m);
 BA.debugLineNum = 194;BA.debugLine="Dim li As List";
Debug.JustUpdateDeviceLine();
_li = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("li", _li);
 BA.debugLineNum = 195;BA.debugLine="For i = 0 To Items.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step9 = 1;
...
Debug.locals.put("start", _start);
 BA.debugLineNum = 201;BA.debugLine="Dim count As Int = 1";
Debug.JustUpdateDeviceLine();
_count = BA.numberCast(int.class, 1);Debug.locals.put("count", _count);Debug.locals.put("count", _count);
 BA.debugLineNum = 202;BA.debugLine="Do While count <= MAX_LIMIT And start + count <";
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("k",_count,__ref.getField(true,"_max_limit" /*RemoteObject*/ )) && RemoteObject.solveBoolean("k",RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_start),_count}, "+",1, 1),_item.runMethod(true,"length"))) {
 BA.debugLineNum = 203;BA.debugLine="Dim str As String";
Debug.JustUpdateDeviceLine();
_str = RemoteObject.createImmutable("");Debug.locals.put("str", _str);
 BA.debugLineNum = 204;BA.debugLine="str = item.SubString2(start, start + count)";
Debug.JustUpdateDeviceLine();
_str = _item.runMethod(true,"substring",(Object)(BA.numberCast(int.class, _start)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_start),_count}, "+",1, 1)));Debug.locals.put("str", _str);
 BA.debugLineNum = 205;BA.debugLine="If noDuplicates.ContainsKey(str) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_noduplicates.runMethod(true,"ContainsKey",(Object)((_str))),b4xsearchtemplate.__c.getField(true,"False"))) { 
 BA.debugLineNum = 206;BA.debugLine="noDuplicates.Put(str, \"\")";
Debug.JustUpdateDeviceLine();
_noduplicates.runVoidMethod ("Put",(Object)((_str)),(Object)((RemoteObject.createImmutable(""))));
 BA.debugLineNum = 207;BA.debugLine="If start = 0 Then m = prefixList Else m = sub";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",RemoteObject.createImmutable(_start),BA.numberCast(int.class, 0))) { 
...
_li.runVoidMethod ("Initialize");
 BA.debugLineNum = 211;BA.debugLine="m.Put(str, li)";
Debug.JustUpdateDeviceLine();
_m.runVoidMethod ("Put",(Object)((_str)),(Object)((_li.getObject())));
 };
 BA.debugLineNum = 213;BA.debugLine="li.Add(Items.Get(i)) 'Preserve the original c";
Debug.JustUpdateDeviceLine();
_li.runVoidMethod ("Add",(Object)(_items.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 };
 BA.debugLineNum = 215;BA.debugLine="count = count + 1";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,63);
...
Debug.locals.put("Dialog", _dialog);
 BA.debugLineNum = 64;BA.debugLine="xDialog = Dialog";
Debug.JustUpdateDeviceLine();
__ref.setField ("_xdialog" /*RemoteObject*/ ,_dialog);
 BA.debugLineNum = 65;BA.debugLine="xDialog.PutAtTop = xui.IsB4A Or xui.IsB4i";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).setField ("_putattop" /*RemoteObject*/ ,BA.ObjectToBoolean(RemoteObject.solveBoolean(".",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4A")) || RemoteObject.solveBoolean(".",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4i"))));
 BA.debugLineNum = 66;BA.debugLine="CustomListView1.AsView.Color = xui.Color_Transpar";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"setColor",__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent"));
 BA.debugLineNum = 67;BA.debugLine="CustomListView1.sv.Color = xui.Color_Transparent";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(false,"_sv").runMethod(true,"setColor",__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent"));
 BA.debugLineNum = 68;BA.debugLine="mBase.Color = xui.Color_Transparent";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setColor",__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent"));
 BA.debugLineNum = 69;BA.debugLine="Sleep(20)";
Debug.JustUpdateDeviceLine();
...
this.state = -1;
;
 BA.debugLineNum = 70;BA.debugLine="Update(\"\", True)";
Debug.JustUpdateDeviceLine();
...
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4j.example.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 73;BA.debugLine="SearchField.TextField.RequestFocus";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,83);
...
Debug.locals.put("Force", _force);
 BA.debugLineNum = 83;BA.debugLine="Private Sub Update(Term As String, Force As Boolea";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 84;BA.debugLine="If Term = LastTerm And Force = False Then Return";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 85;BA.debugLine="LastTerm = Term";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lastterm" /*RemoteObject*/ ,_term);
 BA.debugLineNum = 86;BA.debugLine="If xui.IsB4J = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4J"),b4xsearchtemplate.__c.getField(true,"False"))) { 
 BA.debugLineNum = 87;BA.debugLine="For i = 0 To CustomListView1.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step4 = 1;
...
for (;(step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4) ;_i = ((int)(0 + _i + step4))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 88;BA.debugLine="Dim p As B4XView = CustomListView1.GetPanel(i)";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(BA.numberCast(int.class, _i)));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 89;BA.debugLine="p.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("RemoveViewFromParent");
 BA.debugLineNum = 90;BA.debugLine="ItemsCache.Add(p)";
Debug.JustUpdateDeviceLine();
...
;
 ...
 BA.debugLineNum = 93;BA.debugLine="CustomListView1.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runVoidMethod ("_clear");
 BA.debugLineNum = 95;BA.debugLine="Dim str1, str2 As String";
Debug.JustUpdateDeviceLine();
...
_str2 = RemoteObject.createImmutable("");Debug.locals.put("str2", _str2);
 BA.debugLineNum = 96;BA.debugLine="str1 = Term.ToLowerCase";
Debug.JustUpdateDeviceLine();
_str1 = _term.runMethod(true,"toLowerCase");Debug.locals.put("str1", _str1);
 BA.debugLineNum = 97;BA.debugLine="If Term = \"\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_term,BA.ObjectToString(""))) { 
 BA.debugLineNum = 98;BA.debugLine="AddItemsToList(AllItems, str1)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.example.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_allitems" /*RemoteObject*/ )),(Object)(_str1));
 ...
 BA.debugLineNum = 100;BA.debugLine="If str1.Length > MAX_LIMIT Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_str1.runMethod(true,"length"),__ref.getField(true,"_max_limit" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 101;BA.debugLine="str2 = str1.SubString2(0, MAX_LIMIT)";
Debug.JustUpdateDeviceLine();
_str2 = _str1.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(true,"_max_limit" /*RemoteObject*/ )));Debug.locals.put("str2", _str2);
 ...
 BA.debugLineNum = 103;BA.debugLine="str2 = str1";
Debug.JustUpdateDeviceLine();
_str2 = _str1;Debug.locals.put("str2", _str2);
 };
 BA.debugLineNum = 105;BA.debugLine="AddItemsToList(prefixList.Get(str2), str1)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.example.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), __ref.getField(false,"_prefixlist" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_str2)))),(Object)(_str1));
 BA.debugLineNum = 106;BA.debugLine="AddItemsToList(substringList.Get(str2), str1)";
Debug.JustUpdateDeviceLine();
