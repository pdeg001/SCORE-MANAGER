...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,233);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,225);
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",14,__ref.getField(false, "ba"),__ref,83);
