...
Debug.JustUpdateDeviceLine();
_selected = BA.ObjectToBoolean(RemoteObject.solveBoolean(">",_index,BA.numberCast(int.class, -(double) (0 + 1))));Debug.locals.put("Selected", _selected);Debug.locals.put("Selected", _selected);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_index,BA.numberCast(int.class, -(double) (0 + 1)))) { 
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (b4j.example.b4xdialog.class, "_internaladdstubtoclvifneeded" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextbackgroundcolor")));
