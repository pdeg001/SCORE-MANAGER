...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_i,BA.numberCast(int.class, -(double) (0 + 1)))) { 
...
//if
this.state = 6;
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_lastselectedindex" /*RemoteObject*/ ),_index)) { 
this.state = 3;
;}if (true) break;
...
//if
this.state = 16;
if (RemoteObject.solveBoolean(">",__ref.getField(true,"_delaybeforechangeevent" /*RemoteObject*/ ),BA.numberCast(int.class, 0))) { 
this.state = 9;
}if (true) break;
...
//if
this.state = 15;
if (RemoteObject.solveBoolean("!",_myindex,__ref.getField(true,"_delayindex" /*RemoteObject*/ ))) { 
this.state = 12;
;}if (true) break;
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_items.runMethod(true,"getSize"),BA.numberCast(int.class, 0))) { 
