...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean(">",_whole,BA.numberCast(int.class, 0))) {
 BA.debugLineNum = 107;BA.debugLine="If g > 0 And g Mod 3 = 0 And data.GroupingCharac";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_g,BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean("=",RemoteObject.solve(new RemoteObject[] {_g,RemoteObject.createImmutable(3)}, "%",0, 1),BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean(">",_data.getField(true,"GroupingCharacter" /*RemoteObject*/ ).runMethod(true,"length"),BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"getLength"),_numberstartindex}, "-",1, 1),_data.getField(true,"MinimumIntegers" /*RemoteObject*/ ))) {
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_data.getField(true,"MaximumFractions" /*RemoteObject*/ ),BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(">",_data.getField(true,"MinimumFractions" /*RemoteObject*/ ),BA.numberCast(int.class, 0)) || RemoteObject.solveBoolean(">",_frac,BA.numberCast(double.class, 0)))))) { 
...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("g",_frac,RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(2),_factor}, "*",0, 0)) && RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"getLength"),_fracstartindex}, "-",1, 1),_data.getField(true,"MaximumFractions" /*RemoteObject*/ ))) {
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_w,BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_data.getField(true,"FractionPaddingChar" /*RemoteObject*/ ),BA.ObjectToString("0")) && RemoteObject.solveBoolean(">",_lastzerocount,BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"getLength"),_fracstartindex}, "-",1, 1),_data.getField(true,"MinimumFractions" /*RemoteObject*/ ))) {
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_lastzerocount,BA.numberCast(int.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_sb.runMethod(true,"getLength"),_fracstartindex)) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_data.getField(true,"TextColor" /*RemoteObject*/ ),BA.numberCast(int.class, 0))) { 
