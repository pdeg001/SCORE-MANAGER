...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.example.b4xdatetemplate.class, "_handlemouse" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,_p.getField(true,"TOUCH_ACTION_UP")))));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_btnyearleft" /*RemoteObject*/ ).runMethod(true,"setEnabled",BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(true,"_year" /*RemoteObject*/ ),__ref.getField(true,"_minyear" /*RemoteObject*/ ))));
 BA.debugLineNum = 61;BA.debugLine="btnYearRight.Enabled = year < MaxYear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_btnyearright" /*RemoteObject*/ ).runMethod(true,"setEnabled",BA.ObjectToBoolean(RemoteObject.solveBoolean("<",__ref.getField(true,"_year" /*RemoteObject*/ ),__ref.getField(true,"_maxyear" /*RemoteObject*/ ))));
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_year" /*RemoteObject*/ ),__ref.getField(true,"_selectedyear" /*RemoteObject*/ )) && RemoteObject.solveBoolean("=",__ref.getField(true,"_month" /*RemoteObject*/ ),__ref.getField(true,"_selectedmonth" /*RemoteObject*/ ))) { 
...
{
final int step14 = 1;
final int limit14 = __ref.getField(true,"_daysinmonth" /*RemoteObject*/ ).<Integer>get().intValue();
_day = 1 ;
for (;(step14 > 0 && _day <= limit14) || (step14 < 0 && _day >= limit14) ;_day = ((int)(0 + _day + step14))  ) {
...
Debug.JustUpdateDeviceLine();
_validday = BA.ObjectToBoolean(RemoteObject.solveBoolean(">",_newselectedday,BA.numberCast(int.class, 0)) && RemoteObject.solveBoolean("k",_newselectedday,__ref.getField(true,"_daysinmonth" /*RemoteObject*/ )));Debug.locals.put("validDay", _validday);Debug.locals.put("validDay", _validday);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_newselectedday,__ref.getField(true,"_tempselectedday" /*RemoteObject*/ ))) { 
...
_days = b4xdatetemplate._dateutils.runMethod(false,"_getdaysnames");Debug.locals.put("days", _days);Debug.locals.put("days", _days);
...
{
final int step4 = 1;
final int limit4 = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_firstday" /*RemoteObject*/ ),RemoteObject.createImmutable(7),RemoteObject.createImmutable(1)}, "+-",2, 1).<Integer>get().intValue();
