...
//do while
this.state = 37;
while (RemoteObject.solveBoolean("=",_myindex,__ref.getField(true,"_busyindex" /*RemoteObject*/ ))) {
this.state = 3;
if (true) break;
}
if (true) break;
...
//if
this.state = 20;
if (RemoteObject.solveBoolean(">",_delta,BA.numberCast(float.class, 0))) { 
this.state = 17;
}else {
this.state = 19;
}if (true) break;
...
//if
this.state = 25;
if (RemoteObject.solveBoolean("<",__ref.getField(true,"_currentvalue" /*RemoteObject*/ ),BA.numberCast(float.class, 100))) { 
this.state = 24;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_mvalue" /*RemoteObject*/ ),BA.numberCast(int.class, 100))) { 
